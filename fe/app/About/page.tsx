export default function AboutPage() {
  return (
    <section className="w-full max-w-3xl text-center text-white">
      <article className="rounded-3xl border border-emerald-400/20 bg-[var(--fin-surface)] px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,.5)] ring-1 ring-white/[0.05] sm:px-10 sm:py-12">
        ...
        <p className="mx-auto mt-6 max-w-xl text-pretty text-lg leading-8 text-zinc-400">
